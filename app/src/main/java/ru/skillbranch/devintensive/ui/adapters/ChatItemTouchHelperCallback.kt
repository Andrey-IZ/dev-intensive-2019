...
open class ChatItemTouchHelperCallback(
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        Log.d("M_ChatHelperCallback", "onSwiped: ${viewHolder.adapterPosition}")
    ...
    private fun drawIcon(canvas: Canvas, itemView: View, dX: Float) {
        val icon = itemView.resources.getDrawable(R.drawable.ic_black_archive_24, itemView.context.theme)
    ...
    private fun drawBackGround(canvas: Canvas, itemView: View, dX: Float) {
        Log.d("M_ChatHelperCallback", "dx: $dX, left: ${itemView.left.toFloat()}")
        with(bgRect){
